...
public class Postfix {
	...
	public static void main(String[] args) throws IOException {
		// por algum motivo os arquivos nao sao encontrados,
		// entao deletei as linhas daqui
	...
	private static void runFile(String sourceFilePath) throws IOException {
		String sourceProgram = Files.readString(Path.of(sourceFilePath));
		run(sourceProgram);
	...
	private static void run(String source) {
		try {
			...
			interpreter.env.put("u", "4");
			interpreter.env.put("w", "10");
